...
2. **Verify Backend**: Ensure the .NET backend is running on `http://192.168.8.186:5039`
...
- **Backend URL**: Currently set to `http://192.168.8.186:5039/api` in `api_config.dart`
