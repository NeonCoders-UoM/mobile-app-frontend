...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Montserrat Font Demo',
      theme: ThemeData(
        // Apply Montserrat as the default font for the app
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Montserrat Demo',
          style: AppTextStyles.displayMdBold, // Using bold medium display style
        ),
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Display XL Bold',
                style: AppTextStyles.displayXlBold,
              ),
